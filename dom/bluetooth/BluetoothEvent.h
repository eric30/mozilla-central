                       ...
                       , public nsDOMEvent
{
  public:
    ...
    BluetoothEvent(nsPresContext* aPresContext, nsEvent* aEvent) : nsDOMEvent(aPresContext, aEvent)
                                                                 , mDevice(nsnull)
  { }

    BluetoothEvent() : nsDOMEvent(nsnull, nsnull)
                     , mDevice(nsnull)
  { }

  void SetDeviceInternal(nsIDOMBluetoothDevice* aDevice);
  void SetPropertyNameInternal(const nsString& aPropertyName);
  void SetDeviceAddressInternal(const nsString& aAddress);
